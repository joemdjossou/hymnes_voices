...
def main():
    print("=== h582 Channel Trimming (Remove first 34 seconds) ===")
    ...
    # Verify the result
    print(f"\n=== Verification ===")
    updated_files = sorted(list(h582_dir.glob("channel_*.mp3")))
    print(f"Channel files in h582: {[f.name for f in updated_files]}")
    ...
    if success_count > 0:
        print("\n🎉 h582 trimming completed successfully!")
        print("All channels now have the first 34 seconds removed!")
    else:
